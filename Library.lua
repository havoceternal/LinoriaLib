...
do
    ...
    -- Handles parameters for both full and sub buttons
    local function ProcessButtonParams(Class, Obj, ...)
        ...
        if type(Props) == 'table' then
            ...
            Obj.Half = Props.Half or false -- new setting
        else
            Obj.Text = select(1, ...)
            Obj.Func = select(2, ...)
            Obj.Half = false
    ...
    local function CreateBaseButton(Button)
        ...
        local Outer = Library:Create('Frame', {
            BackgroundColor3 = Color3.new(0, 0, 0);
            BorderColor3 = Color3.new(0, 0, 0);
            Size = UDim2.new(widthScale, widthOffset, 0, 20);
            ZIndex = 5;
        })
    ...
    function Button:AddButton(...)
        ...
        -- Force half size for main button when adding a sub-button
